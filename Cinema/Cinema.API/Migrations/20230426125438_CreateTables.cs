        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Screenwriters_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MoviesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScreenwritersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieScreenwriter", x => new { x.MoviesId, x.ScreenwritersId });
                    table.ForeignKey(
                        name: "FK_MovieScreenwriter_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieScreenwriter_Screenwriters_ScreenwritersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieScreenwriter_ScreenwritersId",
                table: "MovieScreenwriter",
                column: "ScreenwritersId");

            migrationBuilder.CreateIndex(
                name: "IX_Screenwriters_PersonId",
                table: "Screenwriters",
                column: "PersonId",
                unique: true);
        }
